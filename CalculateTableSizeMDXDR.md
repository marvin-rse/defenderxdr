...
1. Calculates the **average row size** using only the last **1 hour** of data. Run this query during a typical, active time of day to capture a realistic average.
...
let SizeSample = union withsource=TableName 
    Device*, Email*, UrlClickEvents, MessageUrlInfo, CloudAppEvents, IdentityDirectoryEvents, IdentityLogonEvents, IdentityQueryEvents, IdentityEvents, IdentityAccountInfo
